...
| Skill | Why |
|-------|-----|
| [Memory Setup](https://clawhub.ai/jrbobbyhansen-pixel/memory-setup) | Your agent remembers you between sessions |
| [Multi Search Engine](https://clawhub.ai/gpyAngyoujun/multi-search-engine) | Web search without any key — the backbone |
| [Summarize](https://clawhub.ai/steipete/summarize) | Read less, understand more |
| [Weather](https://clawhub.ai/steipete/weather) | Quick useful demo of what agents can do |
| [Todoist](https://clawhub.ai/mjrussell/todoist) | Task management that actually sticks |
...
| Skill | Why |
|-------|-----|
| [Self-Improving + Proactive Agent](https://clawhub.ai/ivangdavila/self-improving) | Agent learns your preferences permanently |
| [Deep Research Pro](https://clawhub.ai/parags/deep-research-pro) | Multi-source cited research reports |
| [Gmail](https://clawhub.ai/byungkyu/gmail) | Email directly from chat |
| [Notion](https://clawhub.ai/steipete/notion) | Write to your second brain |
| [Agent Browser](https://clawhub.ai/MaTriXy/agent-browser-clawdbot) | Control the web visually |
| [Filesystem Management](https://clawhub.ai/gtrusler/clawdbot-filesystem) | Files and folders, hands-free |
...
| Skill | Why |
|-------|-----|
| [Git Essentials](https://clawhub.ai/Arnarsson/git-essentials) | Commit, branch, diff — from chat |
| [Docker Essentials](https://clawhub.ai/Arnarsson/docker-essentials) | Container management without memorizing flags |
| [GitHub](https://clawhub.ai/steipete/github) | Issues, PRs, repos — full control |
| [Tmux](https://clawhub.ai/steipete/tmux) | Persistent terminal sessions |
| [Security Auditor](https://clawhub.ai/jgarrison929/security-auditor) | Catch issues before they ship |
| [n8n Workflow Automation](https://clawhub.ai/KOwl64/n8n-workflow-automation) | Build automation pipelines with AI |
...
| Skill | Why |
|-------|-----|
| [Deep Research Pro](https://clawhub.ai/parags/deep-research-pro) | Multi-source deep research with citations |
| [Brave Search](https://clawhub.ai/steipete/brave-search) | Fast, private, real-time web results |
| [Tavily 搜索](https://clawhub.ai/Jacky1n7/openclaw-tavily-search) | AI-optimized search results |
| [News Summary](https://clawhub.ai/joargp/news-summary) | Daily briefing, automated |
| [Summarize](https://clawhub.ai/steipete/summarize) | Long docs → key insights instantly |
| [Obsidian](https://clawhub.ai/steipete/obsidian) | Save research directly to your vault |
...
| Skill | Why |
|-------|-----|
| [Humanize AI text](https://clawhub.ai/moltbro/humanize-ai-text) | Make AI writing sound human |
| [SuperDesign](https://clawhub.ai/mpociot/superdesign) | UI/design specs and mockup descriptions |
| [OpenAI Image Gen](https://clawhub.ai/steipete/openai-image-gen) | Generate images inline |
| [Markdown Converter](https://clawhub.ai/steipete/markdown-converter) | Convert anything to/from Markdown |
| [YouTube Watcher](https://clawhub.ai/Michaelgathara/youtube-watcher) | Research videos without watching them |
| [Xiaohongshu Automation](https://clawhub.ai/Borye/xiaohongshu-mcp) ⚠️ | Xiaohongshu / 小红书 content workflow |
...
| Skill | ⭐ | API Key | Description |
|-------|-----|---------|-------------|
| [Multi Search Engine](https://clawhub.ai/gpyAngyoujun/multi-search-engine) | 297 | 🆓 | Combines multiple engines in one call — the best default search skill |
| [Brave Search](https://clawhub.ai/steipete/brave-search) | 149 | 🔑 | Fast, private, reliable — excellent signal-to-noise ratio |
| [Deep Research Pro](https://clawhub.ai/parags/deep-research-pro) | 45 | 🆓 | Multi-source research with structured cited reports |
| [Exa Web Search (Free)](https://clawhub.ai/Whiteknight07/exa-web-search-free) | 57 | 🆓 | Neural search — finds semantically relevant pages, not just keyword matches |
| [Tavily 搜索](https://clawhub.ai/Jacky1n7/openclaw-tavily-search) | 77 | 🔑 | AI-native search API, great for research workflows |
| [Tavily AI Search](https://clawhub.ai/bert-builder/tavily) | 26 | 🔑 ⚠️ | Alternative Tavily integration — review security scan before installing |
| [DuckDuckGo Web Search](https://clawhub.ai/JakeLin/ddg-web-search) | 10 | 🆓 | Simple, privacy-first, no API key |
| [Searxng](https://clawhub.ai/abk234/searxng) | 22 | 🆓 | Self-hosted meta-search — requires your own SearXNG instance |
| [Baidu Web Search](https://clawhub.ai/ide-rea/baidu-search) | 112 | 🔑 | Chinese-language web search |
| [News Summary](https://clawhub.ai/joargp/news-summary) | 78 | 🆓 | Automated daily news digest |
| [Answer Overflow](https://clawhub.ai/RhysSullivan/answeroverflow) | 123 | 🆓 | Searches Discord dev communities for technical answers |
...
| Skill | ⭐ | API Key | Description |
|-------|-----|---------|-------------|
| [Agent Browser](https://clawhub.ai/MaTriXy/agent-browser-clawdbot) | 64 | 🆓 | Visual browser control — click, type, screenshot, scrape |
| [Playwright MCP](https://clawhub.ai/Spiceman161/playwright-mcp) | 88 | 🆓 | Playwright via MCP — precise browser automation |
| [Playwright (Automation + MCP + Scraper)](https://clawhub.ai/ivangdavila/playwright) | 18 | 🆓 | Full suite: automate, test, and scrape with Playwright |
| [Desktop Control](https://clawhub.ai/matagul/desktop-control) | 214 | 🆓 ⚠️ | Mouse, keyboard, screen control — powerful but review security scan |
| [Xiaohongshu Automation](https://clawhub.ai/Borye/xiaohongshu-mcp) | 79 | 🆓 ⚠️ | 小红书 content workflow via MCP |
| [YouTube Watcher](https://clawhub.ai/Michaelgathara/youtube-watcher) | 217 | 🆓 | Extract transcripts, summaries, and insights from YouTube videos |
| [Camsnap](https://clawhub.ai/steipete/camsnap) | 7 | 🆓 | Take camera snapshots on macOS |
| [Video Frames](https://clawhub.ai/steipete/video-frames) | 79 | 🆓 | Extract frames from local video files for analysis |
| [n8n Workflow Automation](https://clawhub.ai/KOwl64/n8n-workflow-automation) | 88 | 🆓 | Trigger and manage n8n workflows from your agent |

> ⚠️ **Note on Browser Use** (⭐65): flagged by ClawHub security scan — not included here. Review scan before using.
>
> ⚠️ **Note on Playwright Scraper Skill** (⭐38): flagged — use Playwright MCP instead.
...
| Skill | ⭐ | API Key | Description |
|-------|-----|---------|-------------|
| [Memory Setup](https://clawhub.ai/jrbobbyhansen-pixel/memory-setup) | 83 | 🆓* | The foundation — configures MEMORY.md and vector search. **Start here.** |
| [Self-Improving + Proactive Agent](https://clawhub.ai/ivangdavila/self-improving) | 384 | 🆓 | Agent learns from corrections and self-reflects permanently |
| [Memory Manager](https://clawhub.ai/marmikcfc/memory-manager) | 68 | 🆓* | Active memory CRUD — search, update, delete specific memories |
| [Agent Memory](https://clawhub.ai/Dennis-Da-Menace/agent-memory) | 14 | 🆓 | Lightweight memory layer for smaller setups |
| [Elite Longterm Memory](https://clawhub.ai/NextFrontierBuilds/elite-longterm-memory) | 131 | 🔑 ⚠️ | Advanced multi-tier memory — review security scan first |
| [Obsidian](https://clawhub.ai/steipete/obsidian) | 205 | 🆓 | Write and read from your Obsidian vault — knowledge base integration |
| [Notion](https://clawhub.ai/steipete/notion) | 188 | 🔑 | Notion as your agent's external memory and workspace |
| [Session-logs](https://clawhub.ai/guogang1024/session-logs) | 15 | 🆓 | Auto-log sessions for later review and recall |
| [Ontology](https://clawhub.ai/oswalpalash/ontology) | 288 | 🆓 | Structured knowledge graph — build a semantic map of your domain |
...
| Skill | ⭐ | API Key | Description |
|-------|-----|---------|-------------|
| [Gmail](https://clawhub.ai/byungkyu/gmail) | 60 | 🔑 | Read, compose, send Gmail — full email management |
| [AgentMail](https://clawhub.ai/adboio/agentmail) | 45 | 🔑 | Email agent with scheduling and follow-up tracking |
| [imap-smtp-email](https://clawhub.ai/gzlicanyi/imap-smtp-email) | 56 | 🔑 | Universal email via IMAP/SMTP — works with any provider |
| [Himalaya](https://clawhub.ai/lamelas/himalaya) | 50 | 🆓 | Terminal-based email client integration |
| [Slack](https://clawhub.ai/steipete/slack) | 91 | 🔑 | Send and read Slack messages, manage channels |
| [Discord](https://clawhub.ai/steipete/discord) | 48 | 🔑 | Discord integration — messages, channels, server management |
| [Telegram](https://clawhub.ai/codedao12/telegram) | 17 | 🔑 | Send Telegram messages from your agent |
| [Imsg](https://clawhub.ai/steipete/imsg) | 16 | 🆓 | iMessage integration on macOS |
| [Apple Reminders](https://clawhub.ai/steipete/apple-reminders) | 39 | 🆓 | Create and manage Apple Reminders — native macOS/iOS sync |
| [Todoist](https://clawhub.ai/mjrussell/todoist) | 43 | 🔑 | Full Todoist integration — tasks, projects, priorities |
| [Trello](https://clawhub.ai/steipete/trello) | 106 | 🔑 | Trello board management from chat |
| [Caldav Calendar](https://clawhub.ai/Asleep123/caldav-calendar) | 173 | 🔑 | Calendar access via CalDAV — works with iCloud, Fastmail, Nextcloud |
...
| Skill | ⭐ | API Key | Description |
|-------|-----|---------|-------------|
| [Summarize](https://clawhub.ai/steipete/summarize) | 634 | 🆓 | Summarize any text, URL, or document — one of the most-starred skills |
| [Data Analyst](https://clawhub.ai/oyi77/data-analyst) | 51 | 🆓 | Analyze datasets, generate insights, create charts |
| [Data Analysis](https://clawhub.ai/ivangdavila/data-analysis) | 29 | 🆓 | Structured data analysis workflows with code execution |
| [Excel / XLSX](https://clawhub.ai/ivangdavila/excel-xlsx) | 40 | 🆓 | Read, write, and manipulate Excel files |
| [Word / DOCX](https://clawhub.ai/ivangdavila/word-docx) | 62 | 🆓 | Create and edit Word documents |
| [Nano PDF](https://clawhub.ai/steipete/nano-pdf) | 147 | 🆓 | Lightweight PDF reader — fast extraction without heavy deps |
| [Markdown Converter](https://clawhub.ai/steipete/markdown-converter) | 115 | 🆓 | Convert HTML, DOCX, PDF → Markdown and back |
| [Humanize AI text](https://clawhub.ai/moltbro/humanize-ai-text) | 144 | 🆓 | Rewrite AI-generated content to sound natural |
| [Qmd](https://clawhub.ai/steipete/qmd) | 75 | 🆓 | Quarto Markdown documents — academic and technical publishing |
...
| Skill | ⭐ | API Key | Description |
|-------|-----|---------|-------------|
| [GitHub](https://clawhub.ai/steipete/github) | 373 | 🔑 | Issues, PRs, repos — full GitHub API access |
| [Git Essentials](https://clawhub.ai/Arnarsson/git-essentials) | 23 | 🆓 | Commit, branch, merge, diff from chat |
| [Docker Essentials](https://clawhub.ai/Arnarsson/docker-essentials) | 21 | 🆓 | Container management — list, start, stop, logs |
| [Tmux](https://clawhub.ai/steipete/tmux) | 31 | 🆓 | Persistent terminal sessions — survives disconnects |
| [Filesystem Management](https://clawhub.ai/gtrusler/clawdbot-filesystem) | 60 | 🆓 | Safe file and folder operations with guardrails |
| [API Gateway](https://clawhub.ai/byungkyu/api-gateway) | 223 | 🔑 | Connect to 100+ APIs (Google, Microsoft, GitHub, Notion, Airtable) with managed OAuth |
| [n8n Workflow Automation](https://clawhub.ai/KOwl64/n8n-workflow-automation) | 88 | 🆓 | Build and trigger n8n workflows — no-code automation pipelines |
| [Mcporter](https://clawhub.ai/steipete/mcporter) | 114 | 🆓 | MCP server porting and management |
| [Nano Banana Pro](https://clawhub.ai/steipete/nano-banana-pro) | 206 | 🆓 | Swiss-army knife for terminal tasks — highly opinionated |
| [OpenClaw Backup](https://clawhub.ai/alex3alex/openclaw-backup) | 43 | 🆓 | Backup your OpenClaw config and workspace |
| [Model Usage](https://clawhub.ai/steipete/model-usage) | 88 | 🆓 | Track token usage and model costs across sessions |
| [Auto-Updater Skill](https://clawhub.ai/maximeprades/auto-updater) | 280 | 🆓 | Keep your installed skills in sync automatically |
| [Clawdbot Documentation Expert](https://clawhub.ai/NicholasSpisak/clawddocs) | 256 | 🆓 | Answers OpenClaw/Clawdbot questions from official docs |
...
| Skill | ⭐ | API Key | Description |
|-------|-----|---------|-------------|
| [SuperDesign](https://clawhub.ai/mpociot/superdesign) | 119 | 🆓 | UI/UX design specs, component descriptions, design system guidance |
| [UI/UX Pro Max](https://clawhub.ai/xobi667/ui-ux-pro-max) | 86 | 🆓 | Advanced design critique, accessibility, and prototype specs |
| [OpenAI Image Gen](https://clawhub.ai/steipete/openai-image-gen) | 24 | 🔑 | Generate images via DALL-E inline in chat |
| [Edge TTS](https://clawhub.ai/i3130002/edge-tts) | 22 | 🆓 | Text-to-speech using Microsoft Edge voices — free, high quality |
| [OpenAI Whisper](https://clawhub.ai/steipete/openai-whisper) | 213 | 🔑 | Transcribe audio files using Whisper API |
| [OpenAI Whisper API](https://clawhub.ai/steipete/openai-whisper-api) | 31 | 🔑 | Lightweight Whisper API wrapper |
| [YouTube Watcher](https://clawhub.ai/Michaelgathara/youtube-watcher) | 217 | 🆓 | Extract and summarize YouTube content |
| [Video Frames](https://clawhub.ai/steipete/video-frames) | 79 | 🆓 | Frame extraction for video analysis |
| [Gifgrep](https://clawhub.ai/steipete/gifgrep) | 6 | 🆓 | Search and download GIFs — lightweight fun |
| [Spotify Player](https://clawhub.ai/steipete/spotify-player) | 35 | 🔑 | Control Spotify playback from chat |
| [Sonoscli](https://clawhub.ai/steipete/sonoscli) | 40 | 🆓 | Control Sonos speakers via CLI |
...
| Skill | ⭐ | API Key | Description |
|-------|-----|---------|-------------|
| [Stock Market Pro](https://clawhub.ai/kys42/stock-market-pro) | 131 | 🆓* | Comprehensive market data, screener, and portfolio analysis |
| [Stock Watcher](https://clawhub.ai/Robin797860/stock-watcher) | 60 | 🆓 | Monitor stock prices and get alerts |
| [ByteRover](https://clawhub.ai/byteroverinc/byterover) | 98 | 🆓 | Financial data aggregation and analysis |
...
| Skill | ⭐ | API Key | Description |
|-------|-----|---------|-------------|
| [Home Assistant](https://clawhub.ai/iAhmadZain/home-assistant) | 36 | 🔑 | Full Home Assistant integration — devices, automations, scenes |
| [Weather](https://clawhub.ai/steipete/weather) | 294 | 🆓 | Current weather and forecasts — no API key, works everywhere |
| [GoPlaces](https://clawhub.ai/steipete/goplaces) | 26 | 🆓 | Location-aware place search and navigation |
| [Apple Notes](https://clawhub.ai/steipete/apple-notes) | 40 | 🆓 | Read and write Apple Notes on macOS |
| [1Password](https://clawhub.ai/steipete/1password) | 34 | 🆓 | Access 1Password vault items — read-only, secure |
| [Peekaboo](https://clawhub.ai/steipete/peekaboo) | 51 | 🆓 | macOS vision tool — see what's on your screen |
...
| Skill | ⭐ | API Key | Description |
|-------|-----|---------|-------------|
| [Security Auditor](https://clawhub.ai/jgarrison929/security-auditor) | 19 | 🆓* | Automated security review for code and configs — catches common vulnerabilities |
| [healthcheck](https://clawhub.ai/Stellarhold170NT/healthcheck) | 8 | 🆓 ⚠️ | System health and security hardening — review scan before installing |
| [Skill Vetter](https://clawhub.ai/spclaudehome/skill-vetter) | 427 | 🆓 | Vet any skill before installing — analyzes SKILL.md for risks |
...
| Skill | ⭐ | API Key | Description |
|-------|-----|---------|-------------|
| [Self-Improving + Proactive Agent](https://clawhub.ai/ivangdavila/self-improving) | 384 | 🆓 | **The most important skill here.** Agent learns from you permanently, self-reflects, and improves over time |
| [Proactive Agent](https://clawhub.ai/halthelobster/proactive-agent) | 557 | 🆓 | Agent initiates actions without being asked — monitors and responds proactively |
| [Proactive Agent Lite](https://clawhub.ai/BestRocky/proactive-agent-lite) | 21 | 🆓 | Lighter version of Proactive Agent — lower resource footprint |
| [Find Skills](https://clawhub.ai/JimLiuxinghai/find-skills) | 899 | 🆓 | **Most starred skill on ClawHub.** Searches and installs skills from within your agent |
| [Summarize](https://clawhub.ai/steipete/summarize) | 634 | 🆓 | Core utility — appears in almost every workflow |
| [Auto-Updater Skill](https://clawhub.ai/maximeprades/auto-updater) | 280 | 🆓 | Keeps all skills up to date automatically |
| [Free Ride](https://clawhub.ai/Shaivpidadi/free-ride) | 274 | 🆓 | Route tasks to free AI tiers intelligently — reduce costs |
| [Gemini](https://clawhub.ai/steipete/gemini) | 44 | 🔑 | Add Google Gemini as a model option |
| [Skill Creator](https://clawhub.ai/chindden/skill-creator) | 150 | 🆓 ⚠️ | Create new skills from within your agent — review scan first |
| [Evolver](https://clawhub.ai/autogame-17/capability-evolver) | 66 | 🆓 ⚠️ | Agent self-evolves its own capabilities — experimental, review scan |
...
Some skills from ClawHub were deliberately excluded:

| Skill | Reason |
|-------|--------|
| Browser Use | Security flagged — suspicious patterns |
| Desktop Control | Security flagged — review before using |
| Stock Analysis | Security flagged |
| Agent Browser (TheSethRose) | Security flagged |
| Elite Longterm Memory | Security flagged |
| Playwright Scraper Skill | Security flagged |
| Web Search (billyutw) | Security flagged |
| Duplicate entries | Apple Reminders ×4, Brave Search ×2, Evolver ×3, etc. |
...
**PR format:**
```markdown
| [Skill Name](clawhub-link) | ⭐ stars | 🆓/🔑 | One-line description |
```
